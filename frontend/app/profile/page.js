  ...
  const handleImageUpload = async (file) => {
    try {
      ...
      if (!allowedTypes.includes(file.type.toLowerCase())) {
        setUpdateMessage(
          "Invalid file type. Please upload a JPEG, PNG, GIF, or WebP image only."
        );
        setUpdateType("error");
        return;
      }
      ...
      if (!hasValidExtension) {
        setUpdateMessage(
          "Invalid file extension. Please upload an image file (.jpg, .jpeg, .png, .gif, .webp)"
        );
        setUpdateType("error");
        return;
      }
      ...
      if (file.size < minSize) {
        setUpdateMessage(
          "Image file is too small. Please select a valid image."
        );
        setUpdateType("error");
        return;
      }
      ...
      reader.onload = function (e) {
        ...
        // WebP: 52 49 46 46 (RIFF)
          ...
          reader2.onload = function (e2) {
            ...
            const fullHex = Array.from(fullHeader)
              .map((byte) => byte.toString(16).padStart(2, "0"))
              .join("");
            // Check for WebP signature: RIFF....WEBP
            if (fullHex.includes("57454250")) {
              // 'WEBP' in hex
              isValid = true;
            }
            resolve(isValid);
              ...
              <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex-shrink-0">
                  <div className="relative -mt-20 mb-6">
                    <div className="w-40 h-40 rounded-full border-6 border-white shadow-xl bg-black flex items-center justify-center overflow-hidden group cursor-pointer relative">
                      {profileInfo?.profile_Picture ? (
                        ...
                        <svg
                          className="w-20 h-20 text-white transition-all duration-300 group-hover:scale-110"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                          <path
                    ...
                    >
                      ...
                      >
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth={2}
                          d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2-2v16z"
                        />
                      </svg>
                ...
                <div className="flex-1 space-y-6 mt-6 lg:mt-0">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <p className="text-black bg-white p-3 rounded-lg border">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <p className="text-black bg-gray-100 p-3 rounded-lg border flex-1">
                            @{profileInfo?.username || "Not set"}
                          </p>
                          <div
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <p className="text-black bg-white p-3 rounded-lg border flex-1">
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <p className="text-black bg-white p-3 rounded-lg border">
                            {profileInfo?.contact || "Not provided"}
                          </p>
                        )}
                      </div>
                  ...
                  <div className="bg-gray-50 rounded-xl p-6">
                    ...
                    {(profileInfo?.social_links || editedUser?.social_links) &&
                    Object.keys(
                          ...
                          >
                            ...
                            {isEditing ? (
                              ...
                              >
                                ...
                                <svg
                                  className="w-4 h-4 text-gray-500 group-hover:text-purple-500"
                                  fill="none"
                                  stroke="currentColor"
                                  viewBox="0 0 24 24"
                                >

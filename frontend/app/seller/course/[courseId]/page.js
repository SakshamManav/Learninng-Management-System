...
export default function SellerCourse({ params }) {
  ...
  const { currentCourse, courseSection, courseVideoInfo, loading } =
  ...
  const getVideosForSection = (sectionId) => {
    return (
      courseVideoInfo?.filter((video) => video.section_id === sectionId) || []
    );
  };
  ...
  const handleAddVideo = () => {
    console.log("handleAddVideo called, current showAddVideo:", showAddVideo);
    alert("Button clicked! Current showAddVideo: " + showAddVideo);

    setShowAddVideo(true);
    console.log("After setShowAddVideo(true)");
    setTimeout(() => {
      window.scrollTo({
        top: document.body.scrollHeight,
        behavior: "smooth",
  ...
  useEffect(() => {
    if (!loading && showAddVideo) {
      window.location.reload();
    }
    if (!loading && showAddSection) {
      window.location.reload();
    }
  }, [loading]);
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        {activeSection === "sections" && (
          <div className="bg-gray-300 rounded-xl shadow-lg p-8">
                      ...
                      <div className="border-t border-gray-200 bg-gray-50 p-4">
                        <div className="space-y-3">
                          {getVideosForSection(section.id).length > 0 ? (
                            getVideosForSection(section.id).map(
                              (video, videoIndex) => (
                                <div
                                  key={video.id}
            ...
            {showAddSection && (
              <div className="mt-6 bg-gray-50 rounded-lg p-6 border-2 border-dashed border-gray-300 relative">
                {/* Loading Overlay */}
                {loading && (
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      disabled={loading}
                      className="w-full p-3 border border-gray-300 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-colors disabled:bg-gray-100 disabled:cursor-not-allowed"
                    />
                  </div>
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="bg-gray-500 hover:bg-gray-600 disabled:bg-gray-400 disabled:cursor-not-allowed text-white px-6 py-2 rounded-lg transition-colors duration-200 flex items-center gap-2"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
        ...
        {activeSection === "videos" && (
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                onClick={() => {
                  ...
                  console.log("Current showAddVideo:", showAddVideo);
                  setShowAddVideo(true);
                  console.log(
                    "After setShowAddVideo(true) - should be true on next render"
                  );
                  setTimeout(() => {
                    window.scrollTo({
                      top: document.body.scrollHeight,
            ...
            {/* <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {courseVideoInfo?.length > 0 ? (
                ...
                <div className="col-span-full text-center py-12">
                  ...
                  <p className="text-gray-400">
                    Upload your first video to start building your course
                  </p>
                </div>
              )}
            </div> */}
            ...
            {showAddVideo && (
              <div
                ref={videoFormRef}
                className="mt-6 bg-gray-50 rounded-lg p-6 border-2 border-dashed border-gray-300 relative"
              >
                {/* Loading Overlay */}
                {loading && (
                  <div className="absolute inset-0 bg-white bg-opacity-90 flex items-center justify-center z-10 rounded-lg">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      disabled={loading}
                      className="w-full p-3 border border-gray-300 rounded-lg focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-colors disabled:bg-gray-100 disabled:cursor-not-allowed"
                    >
